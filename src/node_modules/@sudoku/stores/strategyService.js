...
class StrategyService {
    constructor() {
        ...
        this.strategyNameList = ["NakedPair", "HiddenSingle", "NakedSingle", "X-Wing","Y-Wing"];
    ...
    execute(grid) {
        ...
        const executeResult = this.strategyServiceImpl.execute(grid, candidate_grid, this.strategyNameList);
        const solution = executeResult.solution;
        const validStrategyList = executeResult.validStrategyList;
        this.newestValidStrategyList = validStrategyList;

...
import { decodeSencodeForGrid, encodeSudoku, encodeOriginSudoku } from '@sudoku/sencode';
import { generateSudoku, solveSudoku } from '@sudoku/sudoku';
import { derived, writable } from 'svelte/store';
import { hints } from './hints';
import { strategyService } from './strategyService'
import { backtrack } from './backtrack'
import { stepStore } from '@sudoku/stores/simpleStrategy';
...
function createGrid() {
	...
	return {
		...
		getOriginSencode(gridStore) {
			return encodeOriginSudoku(gridStore);
		},
...
function createStrategySolution() {
	...
	stepStore.subscribe(($stepStore) => {
		strategyService.setHintStep(stepStore.get());
		let newHintSolution = strategyService.execute(userGrid.get());

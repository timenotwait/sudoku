...
import { decodeSencodeForGrid } from '@sudoku/sencode/index'
    ...
    return {
        ...
        returnToBranch() {
            if(backtrackList.length > 0) {
                ...
                userGrid.setGrid(decodeSencodeForGrid(stateManager.get_state(backtrackItem[0])));
                cursor.set(backtrackItem[1], backtrackItem[2]);
                Candidate.syncWithStrategy();
                // undoList pop至分支点
